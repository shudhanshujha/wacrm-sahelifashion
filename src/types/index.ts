...
export interface Contact {
  ...
  company?: string;
  avatar_url?: string;
  /** DB defaults to 'not_confirmed'. Present on every row from the DB
   *  but marked optional so test fixtures without it don't break. */
...
export type CollectionStatus = 'draft' | 'sent' | 'archived';
...
export type ConsentStatus = 'opted_in' | 'not_confirmed' | 'opted_out';
