...
export default function BroadcastDetailPage() {
  ...
  const funnelSteps: FunnelStep[] = [
    ...
    ...(broadcast.opted_out_count > 0
      ? [
          {
            label: t('stats.optedOut'),
            value: broadcast.opted_out_count,
            color: 'bg-red-500',
          } as FunnelStep,
        ]
      : []),
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-muted-foreground mt-1 flex items-center gap-3 text-sm">
              ...
              {broadcast.collection_id && (
                <>
                  <span>-</span>
                  <button
                    onClick={() =>
                      router.push(`/collections/${broadcast.collection_id}`)
                    }
